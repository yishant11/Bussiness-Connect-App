...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      // Mock successful login - redirect to discover
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-2xl border-0 overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-primary/5 to-pink-500/5 text-center pb-8">
            ...
            <p className="text-gray-600 mt-2">Sign in to continue your love story</p>
          </CardHeader>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 h-12 border-2 border-gray-200 focus:border-primary rounded-lg"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 pr-10 h-12 border-2 border-gray-200 focus:border-primary rounded-lg"
                    required
                  />
                  <button
                    type="button"
